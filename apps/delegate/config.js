...
config.mongodb.pem = process.env.MONGODB_PEM || "./ssl/mongodb.pem";
...
config.webapp.cert = process.env.WEBAPP_PEM || "./ssl/webapp.crt";
config.webapp.pem = process.env.WEBAPP_PEM || "./ssl/webapp.pem";

config.web.key = process.env.WEB_KEY || "./ssl/delegate.key";
config.web.cert = process.env.WEB_CERT || "./ssl/delegate.crt";
config.web.pem = process.env.WEB_PEM || "./ssl/delegate.pem";
